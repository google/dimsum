...
for ARCH in "--cpu=k8" "--copt=-mavx2"; do
  for COMPILATION_MODE in "--compilation_mode=fastbuild" "--compilation_mode=opt" "--copt=-fsanitize=address --linkopt=-fsanitize=address" "--copt=-DDIMSUM_USE_SIMULATED"; do
